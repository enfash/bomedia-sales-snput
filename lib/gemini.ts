...
const salesSchema: Schema = {
  ...
  properties: {
    ...
    rollSize: { type: SchemaType.INTEGER, description: "The width of the roll being used, in feet (e.g. 3, 4, 5, 6, 7, 8, or 10). Any other width is valid too — it is not limited to these." },
...
Rules:
- SAV and Flex rolls come in various widths (commonly 3FT to 10FT, but not limited to that range).
